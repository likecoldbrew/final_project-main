...
//put 추가
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("의료 기록 업데이트", diagnosisInfo);
      ...
      const prescriptionResponse = await fetch(`/api/prescription/updatePrescription/${prescriptionInfo.prescriptionId}`, {
        ...
        body: JSON.stringify({
          medicalRecordId: prescriptionInfo.medicalRecordId,
      ...
      console.log("처방 정보 ", prescriptionInfo);
  ...
  return diagnosisInfo && prescriptionInfo && (
